 ...
 */
public class ImageDisplayService extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            final ImageDAO dao = ImageDAO.getInstance();
            Image image = dao.getImageById(imageId);
            final FileInputStream fileInputStream = new FileInputStream(image.getImagePath() + image.getImageName());
            response.reset(); 
